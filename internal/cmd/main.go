...
func displayDetailedModelAccuracy(db *sql.DB) (table.Model, error) {
	...
	columns := []table.Column{
		...
		{Title: "Total Tests", Width: 12},
		{Title: "Accuracy %", Width: 10},
		{Title: "Correct", Width: 10},
		{Title: "True Pos", Width: 10},
		{Title: "True Neg", Width: 10},
		{Title: "False Pos", Width: 10},
		{Title: "False Neg", Width: 10},
		{Title: "Avg Time(ms)", Width: 12},
